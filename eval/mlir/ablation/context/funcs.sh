...
set_eval_vars() {
    working_seed_pop_dir=$1/seeds
    generate_log=$1/gen.log
    edit_log_dir=$1/edit-log
    generate_dir=$1/gen
    eval_log_dir=$1/eval-log
    cov_batch_dir=$1/cov-batch
    cov_cumulative_dir=$1/cov-cumulative
    cov_summary_dir=$1/cov-summary
    gen_filtered_dir=$1/gen-filtered
    diversity_path=$1/diversity.go.json
}