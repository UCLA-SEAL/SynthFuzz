...
### Evaluation Settings ###
target_binary="/workdir/onnx-mlir/build/Debug/bin/onnx-mlir-opt"
oracle="$target_binary --mlir-print-op-generic --allow-unregistered-dialect %inputpath"
association_file="/workdir/mlir-eval/onnx/dialect-associations.json"
max_options=5

### Save Data Settings ###
temp_dir="/tmp/synthfuzz-eval"
eval_dir=/workdir/mlir-eval/onnx/baseline

# Generate
eval_input_dir=/workdir/onnx-mlir-seeds/seeds
