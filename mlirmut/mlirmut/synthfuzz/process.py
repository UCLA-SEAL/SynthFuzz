...
from mlirmut.synthfuzz.processor import ProcessorTool


def execute():
    parser = ArgumentParser(
        description="Grammarinator: Processor",
        epilog="""
    ...
    parser.add_argument(
        "--lib", metavar="DIR", help="alternative location of import grammars."
    )
    parser.add_argument(
        "--pep8",
        default=False,
    ...
    ProcessorTool(args.language, args.out).process(
        args.grammar,
        options=options,
